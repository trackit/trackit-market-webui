    ...
    render() {
      ...
      if (this.props.gcp.pricing) {
        ...
        gcpChart = <BarChartComponent
          elementId="gcpChart"
          data={gcpData}
          barmode={this.props.view.chartsStacked ? 'group' : 'stack'}
      ...
      if (this.props.aws.pricing) {
        ...
        awsChart = <BarChartComponent
          ...
          data={awsData}
          barmode={this.props.view.chartsStacked ? 'group' : 'stack'}
          title='AWS Storage (monthly price)'
        />;
      } else {
        ...
        <div>
          <div>
            <div className="col-md-12">
              <h4 className="paper-title pull-left">
              ...
              <FormControlLabel
                ...
                control={
                  <Switch
                    ...
                    checked={this.props.view.chartsStacked}
                    onChange={this.props.switchChartsMode}
...
// component's props
const mapStateToProps = ({ gcp, aws, view }) => ({
  gcp,
  aws,
  view
});
